...
export const evaluateScheme = (profile, scheme) => {
  ...
  return {
    ...
    explanationHi:
      status === 'eligible' ? 'आप इस योजना के लिए पात्र हैं।' : `कुछ शर्तें बाकी हैं: ${missingRules.join(', ')}`,
    explanationEn:
      status === 'eligible' ? 'You are eligible for this scheme.' : `Some criteria are pending: ${missingRules.join(', ')}`,
  };
};
